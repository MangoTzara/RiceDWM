...
static char *fonts[]          = { "monospace:size=10", "ttf-monofur:pixelsize=10:antialias=true:autohint=true"  };
static char normbgcolor[]           = "#222222";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#00b38f";
static char selbordercolor[]        = "#00b38f";
...
static const Rule rules[] = {
	...
	*/
	...
	//{ "Conky", NULL, NULL, 0, 1, 0, 0, 0, -1, "dock" },
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_e,	 spawn 	,	 {.v = (const char*[]){ TERMINAL,"-e","RebootGUI",NULL  } } }	 },
	...
	{ MODKEY,			XK_p,			spawn,		{.v = (const char*[]){ TERMINAL, "-e","ranger", NULL } } },
	{ MODKEY|ShiftMask,			XK_p,			spawn,		{.v = (const char*[]){ TERMINAL, "-e","ranger", NULL } } },
	...
	{ MODKEY,                       XK_Print, spawn, {.v = "flameshot", "gui", NULL},
	/* { MODKEY|ShiftMask,		XK_s,		spawn,		SHCMD("") }, */
	//{ MODKEY|ShiftMask,			XK_d,		spawn,          {.v = (const char*[]){ "dmenu_run","-m","1", NULL } } },
	{ MODKEY,			XK_d,		spawn,          {.v = (const char*[]){ "dmenu_run","-x","10","-y","10","-z","1900", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_n,		spawn,		SHCMD(TERMINAL " -e newsboat ; pkill -RTMIN+5 dwmblocks") },
